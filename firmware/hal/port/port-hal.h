...
#define HAL_PORT_INPUT      0
#define HAL_PORT_OUTPUT     1

#define HAL_PORT_DIS_PULLUP 0
#define HAL_PORT_EN_PULLUP  1

#define HAL_PORT_LEVEL_LOW  0
#define HAL_PORT_LEVEL_HIGH 1
