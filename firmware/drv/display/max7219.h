...
#define MAX_CMD_NOOP 0x00   /* No-op                */
#define MAX_CMD_DECM 0x09   /* Decode mode          */
#define MAX_CMD_INTE 0x0A   /* Intensity            */
#define MAX_CMD_SCAN 0x0B   /* Scan limit           */
#define MAX_CMD_LOWP 0x0C   /* Shutdown             */
#define MAX_CMD_TEST 0x0F   /* Display test         */

#define MAX_CMD_LEN  0x02   /* SPI frame length (bytes) */

#define MAX_DEC_NOD  0x00   /* No decode for all digits   */
#define MAX_DEC_D00  0x01   /* Decode digit 0 only        */
#define MAX_DEC_D01  0x03   /* Decode digits 1 to 0       */
#define MAX_DEC_D02  0x07   /* Decode digits 2 to 0       */
#define MAX_DEC_D03  0x0F   /* Decode digits 3 to 0       */
#define MAX_DEC_D04  0x1F   /* Decode digits 4 to 0       */
#define MAX_DEC_D05  0x3F   /* Decode digits 5 to 0       */
#define MAX_DEC_D06  0x7F   /* Decode digits 6 to 0       */
#define MAX_DEC_D07  0xFF   /* Decode all digits (7 to 0) */
